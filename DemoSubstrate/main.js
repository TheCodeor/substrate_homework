...
var connect = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                wsProvider = new api_1.WsProvider(WEB_SOCKET);
...
var getFreeBalance = function (api, address) { return __awaiter(void 0, void 0, void 0, function () {
    var free;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, api_1.ApiPromise.query.system.account(address)];
            case 1:
                free = (_a.sent()).data.free;
                return [2 /*return*/, free];
        }
    });
}); };
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    var api, keyring, alice, free;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, getFreeBalance(api, alice.address)];
            case 2:
                free = _a.sent();
